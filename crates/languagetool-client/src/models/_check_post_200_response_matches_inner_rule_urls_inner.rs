...
pub struct CheckPost200ResponseMatchesInnerRuleUrlsInner {
    /// the URL
    #[serde(rename = "value", skip_serializing_if = "Option::is_none")]
    pub value: Option<String>,
}

impl CheckPost200ResponseMatchesInnerRuleUrlsInner {
    pub fn new() -> CheckPost200ResponseMatchesInnerRuleUrlsInner {
        CheckPost200ResponseMatchesInnerRuleUrlsInner { value: None }
    }
}
